...
--
-- Host: 127.0.0.1
-- Czas generowania: 25 Mar 2020, 14:42
...
--
CREATE DATABASE IF NOT EXISTS `instaboard` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `instaboard`;
...
CREATE TABLE `profile` (
  ...
  `ilosc_like` int(11) NOT NULL,
  `ilosc_obserwujacych` int(11) NOT NULL,
  `ilosc_obserwowanych` int(11) NOT NULL
...
--
ALTER TABLE `profile`
  MODIFY `id_profilu` int(11) NOT NULL AUTO_INCREMENT;
...
('root', '[{\"db\":\"instaboard\",\"table\":\"zgloszenia\"},{\"db\":\"instaboard\",\"table\":\"uzytkownicy\"},{\"db\":\"instaboard\",\"table\":\"profile\"}]');
...
('root', '2020-03-25 13:40:55', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pl\"}');
